...
const ICONS = {
  ...
  /* Official Pinterest brand mark (Simple Icons), a solid glyph rather than a
     Lucide-style outline. Rendered with fill:currentColor, stroke:none — see
     the `filled` flag on SOCIALS in chrome.jsx — everything else in ICONS is
     stroke-drawn and stays that way. */
