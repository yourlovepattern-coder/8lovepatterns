...
const LP_STRIPE = {
  ...
  links: {
    ...
    // anc (The Anchor) is the secure center. It is not sold, and has no public page.
  },
};
  ...
  try {
    ...
    o.innerHTML =
      '<div style="background:#fff;border-radius:18px;padding:24px 30px;font-family:var(--font-body),system-ui,sans-serif;color:#14142B;font-weight:600;font-size:15px;display:flex;align-items:center;gap:14px;box-shadow:0 24px 56px -16px rgba(20,20,43,.45);">' +
        '<span style="width:20px;height:20px;border:3px solid #EAE3D7;border-top-color:#59c021;border-radius:50%;display:inline-block;animation:lpspin .8s linear infinite;"></span>' +
        '<span>' + msg + '</span>' +
      '</div>' +
